...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  useLayoutEffect(() => {
    ...
    // First reset transforms to get clean offsets
    cards.forEach((card) => {
    ...
    if (endElement) {
      endElementTopRef.current = getElementOffset(endElement);
    }
    ...
    return () => {
      ...
      if (lenisInstance && 'destroy' in lenisInstance) {
  ...
  return (
    <div className={`scroll-stack-scroller ${!useWindowScroll ? 'is-local' : ''} ${className}`.trim()} ref={scrollerRef}>
